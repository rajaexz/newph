...
<html lang="en">
  ...
  <div class="ex" id="ex">
            <!-- Home Start -->
            <section class="bg-half-170 d-table w-100 " style=" background-color: transparent;" id="home">
                <div class="bg-overlay"></div>
                <div class="container">
                    <div class="row mt-5 align-items-center">
                        <div class="col-lg-8 col-md-7 col-12">
                            <div class="title-heading mr-lg-5">
                                <h4 class="heading text-white mb-3">Cloud Hosting</h4>
                                ...
                                <ul class="feature-list list-unstyled mb-0">
                                    <li class="text-white-50 my-1"><i class="mdi mdi-arrow-right text-warning mr-2"></i><span class="font-weight-bold">10GB</span> Ram</li>
                                    <li class="text-white-50 my-1"><i class="mdi mdi-arrow-right text-warning mr-2"></i><span class="font-weight-bold">100GB</span> Bandwith</li>
                                    <li class="text-white-50 my-1"><i class="mdi mdi-arrow-right text-warning mr-2"></i><span class="font-weight-bold">100GB SSD</span> Storage</li>
                                    <li class="text-white-50 my-1"><i class="mdi mdi-arrow-right text-warning mr-2"></i><span class="font-weight-bold">3 Domain</span> Hosted Support</li>
                                    <li class="text-white-50 my-1"><i class="mdi mdi-arrow-right text-warning mr-2"></i><span class="font-weight-bold">50</span> Email Account</li>
                                    <li class="text-white-50 my-1"><i class="mdi mdi-arrow-right text-warning mr-2"></i><span class="font-weight-bold">5</span> Database</li>
                                    <li class="text-white-50 my-1"><i class="mdi mdi-arrow-right text-warning mr-2"></i><span class="font-weight-bold">Unlimited</span> Traffic</li>
                                </ul>
                            </div>
                        </div><!--end col-->
        ...
        <!-- Price Start -->
        <section class="section " style=" background-image: linear-gradient(120deg, #0937a2 0%, #1c1102 100%); z-index: -1;">
            <div class="container">
                <div class="row mb-md-4 pb-md-2 justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-md-5 pb-md-5">
                            <h4 class="title text-white mb-3">Hosting / Server Rates</h4>
                                ...
                                <div class="card border-0 rounded mb-2">
                                    <a data-toggle="collapse" href="#collapseOne" class="faq position-relative" aria-expanded="true" aria-controls="collapseOne">
                                        <div class="card-header border-0 bg-light p-3 pr-5" id="headingOne">
                                            <h6 class="title mb-0"> How our <span class="text-primary">Hostick</span> work ? </h6>
                                        </div>
                                    </a>
                                ...
                                <div class="card border-0 rounded mb-2">
                                    <a data-toggle="collapse" href="#collapsefour" class="faq position-relative collapsed" aria-expanded="false" aria-controls="collapsefour">
                                        <div class="card-header border-0 bg-light p-3 pr-5" id="headingfour">
                                            <h6 class="title mb-0"> Is <span class="text-primary">Hostick</span> safer to use with my account ? </h6>
                                        </div>
                                    </a>
