...
<html lang="en">
    ...
    <body>
        ...
        <header id="topnav" class="defaultscroll sticky">
            <div class="container">
                ...
                <div class="buy-button">
                    <a href="#" class="text-dark h6 mr-3 login-dark" data-toggle="modal" data-target="#LoginForm">Login</a>
        ...
        <!-- Home Start -->
        <section class="bg-half-170 d-table w-100 bg-light d-print-none" style="background: url('images/bg/page.png') top center;" id="home">
            <div class="container">
                <div class="row mt-5">
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-5 col-12 d-none d-md-block">
                        <div class="rounded-pill shadow p-4 component-wrapper">
                            <ul class="list-unstyled mb-0">
                                <li class="mb-4"><a href="#intro" class="mouse-down h6 text-dark">Introduction</a></li>
                                <li class="mb-4"><a href="#info" class="mouse-down h6 text-dark">Information</a></li>
                                <li class="mb-4"><a href="#control" class="mouse-down h6 text-dark">Privacy Control</a></li>
                                <li class="mb-4"><a href="#activity" class="mouse-down h6 text-dark">Your Activity</a></li>
                                <li><a href="#question" class="mouse-down h6 text-dark">Questions</a></li>
                            </ul>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-8 col-md-7 col-12">
                        <div class="section-title" id="intro">
                            <h4><i class="mdi mdi-18px mdi-arrow-right"></i> Introduction</h4>
                            <p class="text-muted mt-4">It is said that song composers of the past used dummy texts as lyrics when writing melodies in order to have a 'ready-made' text to sing with the melody.</p>
                            ...
                            <p class="text-muted mb-0">For this reason, dummy text usually consists of a more or less random series of words or syllables. This prevents repetitive patterns from impairing the overall visual impression and facilitates the comparison of different typefaces. Furthermore, it is advantageous when the dummy text is relatively realistic so that the layout impression of the final publication is not compromised.</p>
                        </div>

                        <div class="section-title mt-4 pt-2" id="info">
                            <h4><i class="mdi mdi-18px mdi-arrow-right"></i> Information</h4>
                            <p class="text-muted mt-4">It is said that song composers of the past used dummy texts as lyrics when writing melodies in order to have a 'ready-made' text to sing with the melody.</p>
                            <p class="text-muted">Due to its widespread use as filler text for layouts, non-readability is of great importance: human perception is tuned to recognize certain patterns and repetitions in texts. If the distribution of letters and 'words' is random, the reader will not be distracted from making a neutral judgement on the visual impact and readability of the typefaces (typography), or the distribution of text on the page (layout or type area).</p>
                            <p class="text-muted mb-0">For this reason, dummy text usually consists of a more or less random series of words or syllables. This prevents repetitive patterns from impairing the overall visual impression and facilitates the comparison of different typefaces. Furthermore, it is advantageous when the dummy text is relatively realistic so that the layout impression of the final publication is not compromised.</p>
                        </div>
                        ...
                        <div class="section-title mt-4 pt-2" id="control">
                            <h4><i class="mdi mdi-18px mdi-arrow-right"></i> Privacy Control</h4>
                            <p class="text-muted mt-4">It is said that song composers of the past used dummy texts as lyrics when writing melodies in order to have a 'ready-made' text to sing with the melody.</p>
                            <p class="text-muted">Due to its widespread use as filler text for layouts, non-readability is of great importance: human perception is tuned to recognize certain patterns and repetitions in texts. If the distribution of letters and 'words' is random, the reader will not be distracted from making a neutral judgement on the visual impact and readability of the typefaces (typography), or the distribution of text on the page (layout or type area).</p>
                            <p class="text-muted mb-0">For this reason, dummy text usually consists of a more or less random series of words or syllables. This prevents repetitive patterns from impairing the overall visual impression and facilitates the comparison of different typefaces. Furthermore, it is advantageous when the dummy text is relatively realistic so that the layout impression of the final publication is not compromised.</p>
                        </div>
                        ...
                        <div class="section-title mt-4 pt-2" id="activity">
                            <h4><i class="mdi mdi-18px mdi-arrow-right"></i> Your Activity</h4>
                            <p class="text-muted mt-4">It is said that song composers of the past used dummy texts as lyrics when writing melodies in order to have a 'ready-made' text to sing with the melody.</p>
                            <ul class="list-unstyled text-muted mb-0 ml-4">
                                <li><i class="mdi mdi-arrow-right text-primary mr-1"></i>Terms you search for Hosting</li>
                                <li><i class="mdi mdi-arrow-right text-primary mr-1"></i>Reseller Hosting</li>
                                <li><i class="mdi mdi-arrow-right text-primary mr-1"></i>Cloud Hosting</li>
                                <li><i class="mdi mdi-arrow-right text-primary mr-1"></i>Web Hosting</li>
                                <li><i class="mdi mdi-arrow-right text-primary mr-1"></i>WordPress Hosting</li>
                                <li><i class="mdi mdi-arrow-right text-primary mr-1"></i>Email Hosting</li>
                            </ul>
                        </div>

                        <div class="section-title mt-4 pt-2" id="question">
                            <h4><i class="mdi mdi-18px mdi-arrow-right"></i> Question about privacy</h4>
                            <p class="text-muted mt-4">It is said that song composers of the past used dummy texts as lyrics when writing melodies in order to have a 'ready-made' text to sing with the melody.</p>
                        </div>
        ...
        <!-- Back to top -->
        <a href="#" class="btn btn-icon btn-soft-primary back-to-top d-print-none"><i data-feather="arrow-up" class="icons"></i></a>
        <!-- Back to top -->
