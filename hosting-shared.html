...
<html lang="en">
    ...
    <body>
        ...
        <!-- Home Start -->
        <section class="bg-half-260 d-table w-100 bg-primary" style="background: url('images/bg/shared.png') center center;" id="home">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row mt-5 mt-sm-0 justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-3">Start your work <br> with Shared web hosting</h4>
                            ...
                            <div class="mt-4">
                                <h6 class="text-light mb-0">Starting at <br> <span class="h2 text-white-50">$4.99 / monthly</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card pricing hosting-rate best-plan box-top-position box-hover shadow border-0 rounded overflow-hidden">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-3">Why Shared Hosting ?</h4>
        ...
        <section class="section bg-primary">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title text-white mb-3">Frequently Aksed Questions</h4>
                            <p class="text-white-50 para-desc mx-auto mb-0">Create, collaborate, and turn your ideas into incredible products with the definitive platform for digital design.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
