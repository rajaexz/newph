...
<html lang="en">
    ...
    <header id="topnav" class="defaultscroll sticky  pt-2">
        <div class="container">
            ...
            <div class="buy-button">
                ...
                <a href="contact.html" target="_blank" class="btn btn-primary">Contact</a>
    ...
    <!-- Navbar End -->
        ...
        <!-- Home Start -->
    <div class="ex" id="ex">
        <section class="bg-half-170 d-table w-100 " style="background: url('images/bg/domain.png') top center no-repeat ; background-color: transparent; " id="home">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-3">Search Your Domain Name</h4>
    ...
    <section class="section">
                ...
                <div class="row mb-md-4 pb-md-2 justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-md-5 pb-md-5">
                            <h4 class="title text-white mb-3">Pricing Rates or Tables</h4>
                            <p class="text-white-50 para-desc mx-auto mb-0">Create, collaborate, and turn your ideas into incredible products with the definitive platform for digital design.</p>
                        </div>
                    </div><!--end col-->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 mt-md-5 pt-md-3 mt-lg-0 pt-lg-0">
                        <div class="table-responsive box-top-position bg-white shadow rounded">
                            <table class="table mb-0 table-center">
                                <thead>
                                    <tr class="bg-light">
                                        <th scope="col" style="min-width: 250px;">Domain Name</th>
                                        <th scope="col" style="width: 150px;">Registration</th>
                                        <th scope="col" style="width: 100px;">2 Year</th>
                                        <th scope="col" style="width: 100px;">Renew</th>
                                        <th scope="col" style="width: 140px;">Click Here</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$ 3.99</td>
                                        <td>$ 3.99</td>
                                        <td><a href="javascript:void(0)" class="btn btn-primary">Buy Now</a></td>
                                    </tr>
        ...
        <div class="container-fluid">
            <div class="bg-primary py-5 px-4 rounded-pill" style="background: url('images/cta.png') center center;">
                <div class="row py-5">
                    <div class="container py-md-5">
                        <div class="row justify-content-center">
                            <div class="section-title text-center">
                                <h2 class="text-white mb-4">Managed WordPress Hosting Or Server</h2>
                                <p class="text-white-50 para-desc mx-auto mb-0">Create, collaborate, and turn your ideas into incredible products with the definitive platform for digital design.</p>
            ...
            <div class="container mt-100 mt-60">
                <div class="rounded-pill bg-primary py-5 px-4">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="section-title text-center">
                                <h4 class="title text-white mb-4">Get the latest update from Hostick</h4>
                ...
                <div class="row text-center">
                    <div class="col-sm-6 col-md-7">
                        <div class="text-sm-left">
                            <p class="mb-0 text-foot">© 2020 Hostick. Design with <i class="mdi mdi-heart text-danger"></i> by <a href="http://www.shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                        </div>
                    </div><!--end col-->
